...
class GameWindow(QMainWindow):
    ...
    self.displayWidget.setText(text)  # displayWidget is your QTextEdit or QLabel
...
def thread_start(self):
    ...
    thread_gameLogicWorker = threading.Thread(target=self.main_game_loop(objPlayer))
