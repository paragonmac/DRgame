...
class CustomTextEdit(QTextEdit):
    ...
    def keyPressEvent(self, event):
        if event.key() == Qt.Key_Return or event.key() == Qt.Key_Enter:
            ...
            game_window = self.parent()  # Get the parent widget (GameWindow instance)
            game_window.update_display(self.storedText)  # Access the Body attribute from the GameWindow instance
        else:
