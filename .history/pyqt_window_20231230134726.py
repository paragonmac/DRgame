...
class GameWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        # Connect the signal to a slot in main.py
        self.textEdit.textStored.connect(self.handleTextStored)

    @pyqtSlot(str)
    def handleTextStored(self, text):
        print("Received Text:", text)  # Example action (e.g., print)
