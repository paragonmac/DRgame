...
from PyQt5.QtWidgets import QApplication, QMainWindow, QLineEdit, QVBoxLayout, QWidget, QSplitter, QTextEdit, QTextCursor
...
class GameWindow(QMainWindow):    
    ...
    def update_display(self, text):
        #add text to the bottom of the widget
        self.Room.moveCursor(QTextCursor.End)
