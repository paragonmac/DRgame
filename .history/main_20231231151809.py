...
import player
import threading
from PyQt5.QtWidgets import QMainWindow, QApplication, QTextEdit, QVBoxLayout, QWidget, QSplitter, QSizePolicy, QLabel
...
class CustomTextEdit(QTextEdit):
    ...
    def keyPressEvent(self, event):
        if event.key() == Qt.Key_Return or event.key() == Qt.Key_Enter:
            ...
            self.emitText.emit(self.storedText)  # Emit the signal
        else:
...
if __name__ == '__main__':
    ...
    CustomTextEdit.emitText.connect(GameWindow.update_display)
